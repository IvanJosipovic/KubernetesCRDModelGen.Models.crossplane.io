...
public partial class V1CompositeResourceDefinitionList : IKubernetesObject<V1ListMeta>, IItems<V1CompositeResourceDefinition>
{
    ...
    /// <summary>List of V1CompositeResourceDefinition objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1CompositeResourceDefinition> Items { get; set; }
}
...
public partial class V1CompositeResourceDefinitionSpecDefaultCompositionRevisionSelector
{
    ...
    public IList<V1CompositeResourceDefinitionSpecDefaultCompositionRevisionSelectorMatchExpressions>? MatchExpressions { get; set; }
...
{
    [EnumMember(Value = "LegacyCluster"), JsonStringEnumMemberName("LegacyCluster")]
    LegacyCluster,
...
public partial class V1CompositeResourceDefinitionSpecVersionsSubresources
{
    ...
    public V1CompositeResourceDefinitionSpecVersionsSubresourcesScale? Scale { get; set; }
}
...
public partial class V1CompositeResourceDefinitionSpecVersions
{
    ...
    public V1CompositeResourceDefinitionSpecVersionsSubresources? Subresources { get; set; }
}
...
public partial class V1CompositeResourceDefinitionSpec
{
    ...
    public V1CompositeResourceDefinitionSpecDefaultCompositionRevisionSelector? DefaultCompositionRevisionSelector { get; set; }
    ...
    public required V1CompositeResourceDefinitionSpecNames Names { get; set; }
    ...
    public V1CompositeResourceDefinitionSpecScopeEnum? Scope { get; set; }
    ...
    public required IList<V1CompositeResourceDefinitionSpecVersions> Versions { get; set; }
}
