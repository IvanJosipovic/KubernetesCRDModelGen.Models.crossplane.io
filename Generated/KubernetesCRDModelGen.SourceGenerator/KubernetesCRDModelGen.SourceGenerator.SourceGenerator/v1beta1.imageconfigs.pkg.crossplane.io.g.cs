...
public partial class V1beta1ImageConfigList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ImageConfig>
{
    ...
    public string Kind { get; set; } = "ImageConfigList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ImageConfig objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ImageConfig> Items { get; set; }
}
...
public partial class V1beta1ImageConfigSpecMatchImages
{
    ...
    public V1beta1ImageConfigSpecMatchImagesTypeEnum? Type { get; set; }
}
...
public partial class V1beta1ImageConfigSpecRegistryAuthentication
{
    ...
    public required V1beta1ImageConfigSpecRegistryAuthenticationPullSecretRef PullSecretRef { get; set; }
}
...
public partial class V1beta1ImageConfigSpecRuntime
{
    ...
    public V1beta1ImageConfigSpecRuntimeConfigRef? ConfigRef { get; set; }
}
...
public partial class V1beta1ImageConfigSpecVerificationCosignAuthoritiesAttestations
{
    ...
    public required string PredicateType { get; set; }
}
...
public partial class V1beta1ImageConfigSpecVerificationCosignAuthoritiesKey
{
    ...
    public required V1beta1ImageConfigSpecVerificationCosignAuthoritiesKeySecretRef SecretRef { get; set; }
}
...
public partial class V1beta1ImageConfigSpecVerificationCosignAuthoritiesKeyless
{
    ...
    public required IList<V1beta1ImageConfigSpecVerificationCosignAuthoritiesKeylessIdentities> Identities { get; set; }
...
public partial class V1beta1ImageConfigSpecVerificationCosign
{
    ...
    public required IList<V1beta1ImageConfigSpecVerificationCosignAuthorities> Authorities { get; set; }
}
...
public partial class V1beta1ImageConfigSpecVerification
{
    ...
    public required V1beta1ImageConfigSpecVerificationProviderEnum Provider { get; set; }
}
...
public partial class V1beta1ImageConfigSpec
{
    ...
    public required IList<V1beta1ImageConfigSpecMatchImages> MatchImages { get; set; }
    ...
    public V1beta1ImageConfigSpecRuntime? Runtime { get; set; }
...
public partial class V1beta1ImageConfig : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ImageConfigSpec?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ImageConfig";
